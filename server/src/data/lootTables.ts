...
export const LootTiers: Record<string, WeightedItem[]> = {
    ...
    special_guns: [
        ...
        { item: "model_37", weight: 1.25 },
        { item: "m3k", weight: 1 },
        { item: "arx160", weight: 1.25 },
        { item: "flues", weight: 1 },
        { item: "m16a4", weight: 1.25 },
        ...
        { item: "mosin", weight: 0.25 },
        { item: "vector", weight: 0.75 },
        { item: "negev", weight: 0.25 },
        { item: "mg5", weight: 0.25 },
        { item: "tango_51", weight: 0.25 }
    ],
